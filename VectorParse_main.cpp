...
// the operator op. Returns the result of the
// operation op.
...
int parse(vector<string>& expr) {
	...
	if (first.compare("+") != 0 && first.compare("-") != 0 && first.compare("*") != 0 && first.compare("/") != 0 && first.compare("%") != 0 && first.compare("&&") != 0 && first.compare("||") != 0 && first.compare("<") != 0 && first.compare(">") != 0
    && first.compare("==") != 0 && first.compare("!=") != 0 && first.compare("<=") != 0 && first.compare(">=") != 0 && first.compare("!") != 0 && first.compare("~") != 0) {
		return stoi(first);
	}
